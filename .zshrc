...
plugins=(git catimg command-not-found common-aliases debian dircycle jsontools last-working-dir screen sudo urltools web-search wd gitfast git-extras git-flow git_remote_branch pip gem npm encode64)
